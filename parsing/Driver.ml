...
module PS = struct
  ...
  let print_symbol symbol =
    ...
    | X (N N_separated_or_terminated_list_SEMI_data_field_pattern_) -> "<field patterns>"
    | X (N N_separated_or_terminated_list_SEMI_data_field_expression_) -> "<field expressions>"
    | X (N N_separated_or_terminated_list_SEMI_data_field_def_) -> "<field definitions>"
    | X (N N_separated_or_terminated_list_COMMA_type_binding_) -> "<type bindings>"
    | X (N N_separated_or_preceded_list_BAR_match_branch_) -> "<branches>"
    | X (N N_separated_or_preceded_list_BAR_data_type_def_branch_) -> "<data definitions>"
    | X (N N_separated_nonempty_list_SEMI_data_field_pattern_) -> "<field patterns(1)>"
    | X (N N_separated_nonempty_list_SEMI_data_field_expression_) -> "<field expressions(1)>"
    | X (N N_separated_nonempty_list_SEMI_data_field_def_) -> "<field definitions(1)>"
    ...
    | X (N N_separated_nonempty_list_COMMA_type_binding_) -> "type bindings(1)>"
    ...
    | X (N N_separated_nonempty_list_BAR_match_branch_) -> "<branches(1)>"
    | X (N N_separated_nonempty_list_BAR_data_type_def_branch_) -> "<data definitions(1)>"
    ...
    | X (N N_nonempty_list_terminated_type_binding_COMMA__) -> "type bindings(1)>"
      (* TEMPORARY a simpler definition of separated_or_terminated_list would be good!
         same remark for the optional bar in match constructs and data type defs. *)
      (* TEMPORARY also think about left-recursive lists *)
    | X (N N_nonempty_list_terminated_data_field_pattern_SEMI__) -> "<field patterns(1)>"
    | X (N N_nonempty_list_terminated_data_field_expression_SEMI__) -> "<field expressions(1)>"
    | X (N N_nonempty_list_terminated_data_field_def_SEMI__) -> "<field definitions(1)>"
    | X (N N_nonempty_list_preceded_BAR_match_branch__) -> "<branches(1)>"
    | X (N N_nonempty_list_preceded_BAR_data_type_def_branch__) -> "<data definitions(1)>"
    | X (N N_mode) -> "<mode>"
    ...
    | X (N N_generic_datacon_application_separated_or_terminated_list_SEMI_data_field_pattern__) -> "<data constructor pattern>"
    | X (N N_generic_datacon_application_separated_or_terminated_list_SEMI_data_field_expression__) -> "<data constructor expression>"

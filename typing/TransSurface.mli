...
val translate_implementation: TypeCore.env -> toplevel_item list -> Expressions.implementation

(** [translate_interface] translates an interface. *)
val translate_interface: TypeCore.env -> toplevel_item list -> Expressions.interface

...
INCLUDEFILES=$(shell ocaml mezzocompilejs.ml)

web/js/mezzo.js:
	$(OCAMLBUILD) \
	  -tag-line "not (<corelib/*> or <stdlib/*> or <parsing/grammar.*>): debug, package(js_of_ocaml), package(js_of_ocaml.syntax), syntax(camlp4o)" \
	  mezzoweb.byte
	js_of_ocaml mezzoweb.byte -opt 3 -o $@ web/js/override.js -I web $(INCLUDEFILES)
